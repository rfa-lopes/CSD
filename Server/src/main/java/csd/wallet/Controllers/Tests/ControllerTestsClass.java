...
public class ControllerTestsClass extends RestResource implements ControllerTestsInterface {
    ...
    public ResponseEntity<String> test1() {
        ...
        return super.getResponse(bftClient.getInvoke(RequestType.TEST_1, MessageType.ASYNC_REQUEST, -2));
    }

    @Override
    public ResponseEntity<String> test2() {
        Logger.info("Request: TEST2");
        return super.getResponse(bftClient.getInvoke(RequestType.TEST_2, MessageType.ASYNC_REQUEST, -2));
    }

    @Override
    public ResponseEntity<String> test3() {
        Logger.info("Request: TEST3");
        return super.getResponse(bftClient.getInvoke(RequestType.TEST_3, MessageType.ASYNC_REQUEST, -2));
    ...
    public ResponseEntity<Void> test4() {
        ...
        return super.getResponse(bftClient.getInvoke(RequestType.TEST_4, MessageType.ASYNC_REQUEST, -2));

...
public interface TransferCommandsInter {
	...
	/**
	 * Description Adds amount of money to wallet with given id
	 * 
	...
	/**
	 * Description Removes amount of money to wallet with given id
	 * 
	 * @param id     Wallet's id
	...
	/**
	 * Description Lists all made transfers
	 * 
	 * @return Status code of operation
	 */
	...
	/**
	 * Description Lists all made transfers regarding the wallet with the given ID
	 * 
	 * @param id Wallet's id
	 * @return Status code of operation
	 */
